    ...
    fn parse_sheet(&self, range: &Range<Data>) -> Vec<ExternalTransaction> {
        match self {
            ...
            SheetFormat::BankAustria => range
                ...
                .collect(),
            SheetFormat::Transferwise => range
                .rows()
                .skip(1)
